...
- (void)setupUI {
    ...
    NSTextField *outputTopLabel = [[NSTextField alloc] initWithFrame:NSMakeRect(20, generalView.bounds.size.height - 50, 300, 20)];
    ...
    NSTextField *inputTopLabel = [[NSTextField alloc] initWithFrame:NSMakeRect(20, generalView.bounds.size.height - 50, 300, 20)];
